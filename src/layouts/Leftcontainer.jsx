...
export default function Leftcontainer() {
    ...
    const tabsList = [
        { name: "Shadow", compnent: <ShadowList /> },
        { name: "BoxPanel", compnent: <BoxPanel /> },
    ]
        ...
        <div className='relative mt-20 w-[600px] h-[550px] border rounded-b rounded-tr border-gray-300 shadow-xl bg-gray-50 md:mt-0'>
            <div className='flex absolute -translate-y-full -left-[1px]'>
                {tabsList.map((tab, index) => 
                   ( <button key={index} onClick={()=>setTabs(index)} className='min-w-[125px] py-2 px-3 mr-4 font-bold border-t border-x 
